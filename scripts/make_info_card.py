...
# ===========================================================================
HOST = "jyothir"   # shown as  jyothir@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now",  "Building things that shouldn't work, but do"),
    ("kv", "Also", "Chronic tab-hoarder & caffeine-driven dev"),
    ("kv", "Edu",  "CS undergrad, self-taught the rest"),
    ("kv", "Loc",  "Somewhere between IDE and terminal"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Tailwind"),
    ("kv", "Backend",  "Node, Python, FastAPI, Postgres"),
    ("kv", "AI / ML",  "LangChain, Claude API, RAG, agents"),
    ("kv", "Tooling",  "Git, Docker, Vercel, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Ships weekend projects like it's a full-time job"),
    ("bul", "Reads docs so you don't have to (but you should)"),
    ("bul", "Prefers clean commits over clever ones"),
]
